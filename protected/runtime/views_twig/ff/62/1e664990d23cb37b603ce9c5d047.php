...
class __TwigTemplate_ff621e664990d23cb37b603ce9c5d047 extends Twig_Template
{
...
\t";
        ...
        if ($this->getAttribute($_this_, "breadcrumbs")) {
            ...
            echo "\t\t";
            if (isset($context["this"])) { $_this_ = $context["this"]; } else { $_this_ = null; }
            echo $this->getAttribute($_this_, "widget", array("zii.widgets.CBreadcrumbs", array("links" => $this->getAttribute($_this_, "breadcrumbs")), true, ), "method");
            // line 42
            echo "<!-- breadcrumbs -->
\t";
        }
