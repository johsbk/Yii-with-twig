...
class __TwigTemplate_142fe3b9d5ca97792941f0256fa9b7e0 extends Twig_Template
{
...
\t\t";
        ...
        echo $this->getAttribute($_Yii_, "powered", array(), "method");
        echo "
\t</div><!-- footer -->
...
";
    ...
    public function block_title($context, array $blocks = array())
    {
        if (isset($context["C"])) { $_C_ = $context["C"]; } else { $_C_ = null; }
        if (isset($context["this"])) { $_this_ = $context["this"]; } else { $_this_ = null; }
        echo $this->getAttribute($this->getAttribute($_C_, "Html"), "encode", array($this->getAttribute($_this_, "pageTitle"), ), "method");
    }
...
\t<link rel=\"stylesheet\" type=\"text/css\" href=\"";
        // line 9
        if (isset($context["App"])) { $_App_ = $context["App"]; } else { $_App_ = null; }
        echo $this->getAttribute($this->getAttribute($_App_, "request"), "baseUrl");
